...
public class TopicAddIntegrationTest {
    ...
    private static final InfoTopic INFO_TOPIC_DATA = new InfoTopic("Topic", UUID.fromString("7788d4de-48b2-401e-97a8-a6106b55e2ee"));

    @Before
    public void setup() throws IOException {
        mockInfoService = buildMockService(restTemplate);
        mockInfoService
                .expect(ExpectedCount.times(4),requestTo("http://localhost:8085/caseType"))
                .andExpect(method(GET))
                .andRespond(withSuccess(mapper.writeValueAsString(Set.of(CASE_DATA_TYPE)), MediaType.APPLICATION_JSON));
        mockInfoService
                .expect(requestTo("http://localhost:8085/topic/7788d4de-48b2-401e-97a8-a6106b55e2ee"))
                .andExpect(method(GET))
                .andRespond(withSuccess(mapper.writeValueAsString(INFO_TOPIC_DATA), MediaType.APPLICATION_JSON));
    }
