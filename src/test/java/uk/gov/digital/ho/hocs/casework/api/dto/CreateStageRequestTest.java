...
public class CreateStageRequestTest {
    ...
    public void getCreateStageRequest() {
        ...
        CreateStageRequest createStageRequest = new CreateStageRequest(stageType, teamUUID, deadline);
    ...
    public void getCreateStageRequestNull() {
        ...
        CreateStageRequest createStageRequest = new CreateStageRequest(null, null, null);
