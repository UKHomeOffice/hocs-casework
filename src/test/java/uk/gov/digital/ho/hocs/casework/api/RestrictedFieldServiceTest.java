...
public class RestrictedFieldServiceTest {
    ...
    public void caseData_shouldNotRemoveCaseDataIfCaseTypeNotFound() {
        ...
        restrictedFieldService.removeRestrictedFieldsFromCaseData("UNKNOWN", AccessLevel.RESTRICTED_OWNER, caseData);
    ...
    public void caseData_shouldNotRemoveCaseDataIfAccessLevelHigherThanRestricted() {
        ...
        restrictedFieldService.removeRestrictedFieldsFromCaseData("TEST", AccessLevel.OWNER, caseData);
    ...
    public void caseData_shouldOnlyRemoveSingleValueWithAccessLevelSummary() {
        Map<String, String> caseData = new HashMap<>(Map.of("Field1", "Test1", "Field2", "Test2"));

        restrictedFieldService.removeRestrictedFieldsFromCaseData("TEST", AccessLevel.SUMMARY, caseData);

        assertThat(caseData).hasSize(1).containsEntry("Field2", "Test2");
    }
    ...
    public void caseData_shouldOnlyRemoveValuesAcrossAccessLevels() {
        ...
        restrictedFieldService.removeRestrictedFieldsFromCaseData("TEST", AccessLevel.RESTRICTED_OWNER, caseData);
    ...
    public void additionalFields_shouldNotRemoveCaseDataIfCaseTypeNotFound() {
        ...
        restrictedFieldService.removeRestrictedFieldsFromAdditionalFields("UNKNOWN", AccessLevel.RESTRICTED_OWNER,
            additionalFields);
    ...
    public void additionalFields_shouldNotRemoveCaseDataIfAccessLevelHigherThanRestricted() {
        ...
        restrictedFieldService.removeRestrictedFieldsFromAdditionalFields("TEST", AccessLevel.OWNER, additionalFields);
    ...
    public void additionalFields_shouldOnlyRemoveSingleValueWithAccessLevelSummary() {
        ...
        List<AdditionalFieldDto> additionalFields = new ArrayList<>(
            List.of(AdditionalFieldDto.from(new AdditionalField("", "Test1", "", "", "Field1")), field2));

        restrictedFieldService.removeRestrictedFieldsFromAdditionalFields("TEST", AccessLevel.SUMMARY,
            additionalFields);

        assertThat(additionalFields).hasSize(1).contains(field2);
    }

    @Test
    public void additionalFields_shouldOnlyRemoveValuesAcrossAccessLevels() {
        List<AdditionalFieldDto> additionalFields = new ArrayList<>(
            List.of(AdditionalFieldDto.from(new AdditionalField("", "Test1", "", "", "Field1")),
                AdditionalFieldDto.from(new AdditionalField("", "Test2", "", "", "Field2"))));

        restrictedFieldService.removeRestrictedFieldsFromAdditionalFields("TEST", AccessLevel.RESTRICTED_OWNER,
            additionalFields);

        assertThat(additionalFields).isEmpty();
    }
