...
public class CaseDataServiceTest {
    ...
    public void shouldCreateCase() throws EntityCreationException {
        ...
        CaseData caseData = caseDataService.createCase(UUID.randomUUID(),"Type");
    ...
    public void shouldCreateStage() throws EntityCreationException {
        caseDataService.createStage(UUID.randomUUID(), uuid, "CREATE", new HashMap<>());
    ...
    public void shouldCreateStageMissingUUIDException1() throws EntityCreationException {
        caseDataService.createStage(UUID.randomUUID(), null, "CREATE", new HashMap<>());
    }
    ...
    public void shouldUpdateCase() throws EntityCreationException, EntityNotFoundException {
        ...
        when(caseDataRepository.findByUuid(any())).thenReturn(new CaseData(UUID.randomUUID(), "Type", 123L));
    ...
    public void shouldUpdateStage() throws EntityCreationException, EntityNotFoundException {
        ...
        when(stageDataRepository.findByUuid(any())).thenReturn(new StageData(UUID.randomUUID(), uuid, "CREATE", "Some data"));
    ...
    public void shouldGetCase() throws EntityNotFoundException {
        ...
        when(caseDataRepository.findByUuid(any())).thenReturn(new CaseData(UUID.randomUUID(), "", 1L));
