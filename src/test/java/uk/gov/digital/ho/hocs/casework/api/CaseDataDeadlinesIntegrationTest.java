...
public class CaseDataDeadlinesIntegrationTest {
    ...
    public void shouldOverrideCaseAndStageSlas() throws JsonProcessingException {
        ...
        final CaseData caseData = caseDataRepository.findActiveByUuid(
        ...
        final Stage stage = stageRepository.findActiveBasicStageByCaseUuidStageUUID(
            UUID.fromString("b2e0b71c-d9be-4a0b-8e6c-38d06146f0e0"),
    ...
    private void setupMockTeams(String caseType, int permission) throws JsonProcessingException {
        ...
        mockInfoService.expect(requestTo("http://localhost:8085/stages/caseType/TEST")).andExpect(
            ...
            mapper.writeValueAsString(Set.of(new StageTypeDto("initial draft", "DRAFT", "INITIAL_DRAFT", 10, 5, 1))),
