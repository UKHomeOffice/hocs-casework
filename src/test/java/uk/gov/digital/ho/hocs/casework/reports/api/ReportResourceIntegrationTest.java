...
public class ReportResourceIntegrationTest {
    ...
    @TestConfiguration
    public static class MockInfoServiceRestConfiguration {
        ...
        @Bean
        public MockRestServiceServer mockRestServiceServer() throws JsonProcessingException {
            MockRestServiceServer.MockRestServiceServerBuilder infoBuilder = bindTo(restTemplate);
            infoBuilder.ignoreExpectOrder(true);
            MockRestServiceServer server = infoBuilder.build();

            setupInfoServiceMocks(server);

            return server;
        }

        void setupInfoServiceMocks(MockRestServiceServer server) throws JsonProcessingException {
