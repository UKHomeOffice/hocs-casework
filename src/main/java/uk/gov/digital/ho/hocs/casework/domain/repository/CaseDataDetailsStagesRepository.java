...
@Service
@Slf4j
public class CaseDataDetailsStagesRepository extends JsonConfigFolderReader {

    public final Map<String, Map<String, List<CaseDataDetails.Fields>>> detailsFields;

    public CaseDataDetailsStagesRepository(ObjectMapper objectMapper) {
        super(objectMapper);

        detailsFields = readValueFromFolder(new TypeReference<CaseDataDetails>() {});
    }

    public Map<String, List<CaseDataDetails.Fields>> getStagesDetailsFieldsByType(String type) {
