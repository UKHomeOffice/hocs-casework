ALTER TABLE casework.case_data ADD COLUMN owner_uuid UUID;
ALTER TABLE casework.case_data ADD COLUMN owner_team_uuid UUID;
...
AS SELECT c.id,
          ...
          c.date_received,
          c.case_deadline,
          DATE_PART('day', AGE(c.case_deadline, c.created)) AS days_until_deadline
